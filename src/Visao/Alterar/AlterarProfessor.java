...
// METODO PARA PESQUISAR O PROFESSOR QUE SERAR ALTERADO
...
// METODO PARA ALTERAR AS INFORMACOES DO PROFESSOR
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed

        int  cpff = Integer.parseInt(this.jTextField1.getText());
        int  codigoo = Integer.parseInt(this.jTextField3.getText());
         String nomee  =  this.jTextField2.getText();
     String senhaa =     jPasswordField1.getText();

        if(nomee.equals("")|| senhaa.equals("") ){
